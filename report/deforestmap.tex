...
\begin{abstract}
  ...
  of long-term deforestation trends in Madagascar. In this study, we propose 
  a new approach combining historical
  ...
  from 2000 to 2014. We estimated that Madagascar has lost 44\% of its natural forest
  ...
  forest edge. Accurate forest-cover change maps can
...
\begin{figure}[h!]
  \centering
    ...
    \includegraphics[width=11cm]{ecoregion.png}
