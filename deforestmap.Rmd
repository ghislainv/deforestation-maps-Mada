...
tab.1 <- defor.df
names(tab.1) <- c("Year","Forest (ha)", "Annual defor. (ha/yr)", "theta (%/yr)")
kable(tab.1)
```

Table 1: **Evolution of the forest cover and deforestation intensity from 1950s to 2014 in Madagascar**. Madagascar has lost `r perc.1`% of its natural forest in 40 years between _c._ 1973 and 2014 (and about `r perc.2`% in 60 years since _c._ 1953). If the deforestation has progressively slowed down from _c._ 1973 to 2010 (from `r d.1` to `r d.2`%/yr), most likely due to a decrease of available arable lands under the remaining forests and to a decrease of forest accessibility, the deforestation has recently increased, with a doubling deforestation on the period 2010-2014 compared to 2000-2010. This increase could be attributed to both political instability (political crisis in 2009) and to an explosion of the demography (according to the @UN2015, population has increased from about 16M inhabitants in 2000 to 24M in 2014). Natural forest covers 8.9 Mha in 2014 and current (period 2000-2014) mean annual deforestation rate is of about 70,000 ha/yr. 
