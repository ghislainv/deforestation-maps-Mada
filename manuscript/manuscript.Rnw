...
present in 2000, the pixel was also forested in 1990. Indeed, there is little evidence of natural forest
regeneration in Madagascar \citep{Grouzis2001, Harper2007}, especially over such a short period of time. The remaining
...
million ha which was left as is. We also reprojected the forest cover map of year 1953 to a
...
\begin{figure}[h!]
  \centering
    ...
    \caption{\textbf{Ecoregions and forest types in Madagascar.}
      ...
      Forest types are defined on the basis of their appartenance to
